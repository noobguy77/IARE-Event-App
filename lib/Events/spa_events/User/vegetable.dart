  ...
  text: TextSpan(
    ...
    children: <TextSpan>[
      ...
      TextSpan(
                  ...
                  text: 'Participates must use any fruit or vegetable item that is available for carving.\n',
                  style: TextStyle(
      ...
      TextSpan(
        ...
        style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.black),),
                ...
                TextSpan(
                  text: 'No pre preparation fruits or vegetable can be used in competition is allowed.\n',
      ...
      TextSpan(
        text: '3)',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.black),
                ...
                TextSpan(
                  text: 'No mark or drawings should visible on fruit or vegetable.\n',
                  style: TextStyle(color: Colors.black,fontSize: 18.0,fontFamily: 'Nunito'),
                ),
    ...
    return new MaterialApp(
        ...
        home: new Scaffold(
            appBar: new AppBar(
              ...
              title: new Text('Vegetable Carving',textAlign: TextAlign.center,),
              actions:<Widget>[
