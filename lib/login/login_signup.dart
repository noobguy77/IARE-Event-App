...
// if you get error above try adding dependencies of flutter icons
import 'palette.dart';
...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
                  ...
                  children: [
                    RichText(
                      text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: isSignupScreen ? "to IARE," : " Back,",
                              style: TextStyle(
                                fontSize: 25,
  ...
  Container buildSigninSection() {
    return Container(
      ...
      child: Column(
        children: [
          buildTextField(Icons.mail_outline, "info@iare.ac.in", false, true),
          buildTextField(
  ...
  Container buildSignupSection() {
    return Container(
      ...
      child: Column(
        children: [
          buildTextField(MaterialCommunityIcons.account_outline, "Roll Number",
              false, false),
          buildTextField(
              MaterialCommunityIcons.phone, "phone", false, false),
          buildTextField(
